...
public class Voiture1 {
   ...
   private  String Modele ;
    ...
    public Voiture1(int Idvoit) {
        this.Idvoit = Idvoit;
    }

    public Voiture1(String Matricule, int Puissance_fiscalle, String Image_v, String Modele) {
    ...
    public Voiture1(int Idvoit, String Matricule, int Puissance_fiscalle, String Image_v, String Modele) {
        this.Idvoit = Idvoit;
        this.Matricule = Matricule;
        this.Puissance_fiscalle = Puissance_fiscalle;
        this.Image_v = Image_v;
